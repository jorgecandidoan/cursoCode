...
class DbTableGatewayJoin extends DbSelect
{
    /**
     * Constructs instance.
     *
     ...
     */
    public function __construct(TableGateway $tableGateway, $where = null, $order = null, $group = null, $having = null, $join = null)
    {
        ...
        if($join){
            ...
            foreach($join as $j){
                $select->join($j['tabela'],$j['condicao']);
            }
        }
